...
#define _hid_msg_MessageId_MAX hid_msg_MessageId_EINK_SET_IMAGE
#define _hid_msg_MessageId_ARRAYSIZE ((hid_msg_MessageId)(hid_msg_MessageId_EINK_SET_IMAGE+1))
