...
void Easing_Woking(int  uType, int dwTimer, int dwSleep, void (*lpCbk)(double,double,int,int,bool&a,int,void*) , int param1, void* param2, double start, double end, int addr) {
    int count;
    double pro;
    double cur;
    bool bStop = false;
